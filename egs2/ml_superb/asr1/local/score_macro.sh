...
# Default values
exp_dir="/nlp/scr/ananjan/asrdro/exp_subset/asr_train_asr_xlsr_dro_language_orig_1h/decode_asr_asr_model_valid.loss.ave/test_1h_lid/score_cer/few_shot/trained"
