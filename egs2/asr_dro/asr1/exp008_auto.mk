...
eval-xlsr-ctc-aleb-0.0001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-sceb-0.0001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-xlsr-ctc-sceb-0.0001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-all: /
	make eval-mms-ctc-aleb-0.0001 /
	make eval-xlsr-ctc-aleb-0.0001 /
	make eval-mms-ctc-sceb-0.0001 /
	make eval-xlsr-ctc-sceb-0.0001 /
	echo 'All done'
