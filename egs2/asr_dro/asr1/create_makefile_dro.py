...
for step_size in STEP_SIZE:
    for model in MODELS.keys():
        ...
        bash_file += f"nlprun -n train_asr_{model}_aleb_dro_{step_size} -g 1 -a asrdro -o results/{EXP}/train_asr_{model}_aleb_dro_{step_size}.txt --mail-user ananjan -d a6000 'source ../../../tools/activate_python.sh; make train_asr_{model}_aleb_dro_{step_size}'\n"
