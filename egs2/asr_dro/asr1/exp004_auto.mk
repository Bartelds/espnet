...
COMMON_EVAL_ARGS=\
	--exp_dir $(EXP_DIR)/asr_train-$(subst eval-,,$@)/decode_asr_asr_model_valid.loss.ave/test_1h_lid/score_cer/few_shot/trained/ 
...
eval-mms-ctc-aleb-0.0005: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-sceb-0.0005: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-aleb-0.0001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-sceb-0.0001: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-aleb-5e-05: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-sceb-5e-05: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-aleb-1e-05: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-mms-ctc-sceb-1e-05: results/$(EXPERIMENT_ID)/
	$(EVAL_CMD)

eval-all: /
	make eval-mms-ctc-aleb-0.0005 /
	make eval-mms-ctc-sceb-0.0005 /
	make eval-mms-ctc-aleb-0.0001 /
	make eval-mms-ctc-sceb-0.0001 /
	make eval-mms-ctc-aleb-5e-05 /
	make eval-mms-ctc-sceb-5e-05 /
	make eval-mms-ctc-aleb-1e-05 /
	make eval-mms-ctc-sceb-1e-05 /
	echo 'All done'
